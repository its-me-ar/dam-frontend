        ...
        <Card>
          <CardContent className='p-8 text-center'>
            <div className='text-gray-500'>
              ...
              <p className='text-sm'>
                No one has shared any assets with you yet.
              </p>
            </div>
          </CardContent>
        </Card>
              ...
              <CardContent className='p-0'>
                <div className='divide-y divide-gray-100'>
                  ...
                  {data?.map(a => (
                    <div
                      key={a.id}
                      className='grid grid-cols-[auto_1fr] md:grid-cols-[auto_1fr_100px_140px_140px_120px_80px] items-center gap-3 px-4 py-3 hover:bg-gray-50 cursor-pointer'
                      onClick={() =>
                        setSelected({
                          id: a.assetId,
                          name: a.name,
