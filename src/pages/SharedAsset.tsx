              ...
              <CardContent className='p-6'>
                <div className='space-y-4'>
                  <div>
                    ...
                    <div className='flex items-center gap-2'>
                      <span
                        className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium ${getFileTypeColor(asset.mimeType)}`}
                      >
                  ...
                  <div className='space-y-3'>
                    ...
                    {asset.uploader ? (
                      <div className='flex items-center gap-3 text-sm'>
                        ...
                        <span className='text-gray-600'>
                          Uploaded by {asset.uploader.fullName} (
                          {asset.uploader.role})
                        </span>
                      </div>
                    ) : null}
                    ...
                    {asset.sharedBy &&
                    asset.sharedBy.id !== asset.uploader?.id ? (
                      <div className='flex items-center gap-3 text-sm'>
                  ...
                  <div className='flex gap-3 pt-4 border-t border-gray-200'>
                    <button
                      onClick={() =>
                        downloadFile(asset.paths.original, asset.name)
                      }
