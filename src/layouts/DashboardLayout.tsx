  ...
  return (
    <div className='min-h-screen bg-gray-50 text-gray-900'>
      ...
      <div className='flex w-full'>
        <aside
          className={`fixed top-14 bottom-0 left-0 z-10 w-56 transform overflow-y-auto border-r border-gray-200 bg-white pl-3 pr-2 py-4 transition-transform md:translate-x-0 ${open ? 'translate-x-0' : '-translate-x-full'}`}
        >
