...
export function SharedAssetPreviewModal({ asset, isOpen, onClose }: SharedAssetPreviewModalProps) {
  ...
  const videoSources = useMemo(() => {
    ...
    const sorted = filtered.sort((a, b) => allowedQualities.indexOf(a[0]) - allowedQualities.indexOf(b[0]))
