...
export function StatCard({ title, value, delta, tone = 'peach' }: StatCardProps) {
  return (
    <Card>
      <CardContent>
        <div className="flex items-start justify-between">
          ...
          <div className={`h-8 w-8 shrink-0 rounded-full ${toneToClasses[tone]} grid place-items-center`}>↗</div>
        </div>
      </CardContent>
    </Card>
  )
